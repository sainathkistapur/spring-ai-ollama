package dev.springai.ollama.rag.etl.controller;

import dev.springai.ollama.rag.etl.json.JsonEtlPipelineService;
...
@RequestMapping("/springai/ollama/rag/etl/json-etl")
