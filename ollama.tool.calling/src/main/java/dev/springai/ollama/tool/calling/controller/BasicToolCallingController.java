package dev.springai.ollama.tool.calling.controller;

import dev.springai.ollama.tool.calling.tools.datetime.DateTimeTools;
import lombok.RequiredArgsConstructor;
import org.springframework.ai.chat.client.ChatClient;
import org.springframework.web.bind.annotation.*;

@RestController
@RequestMapping("/springai/ollama/toolcalling")
...
public class BasicToolCallingController {
    ...
    public String setAlarm(@RequestParam String time) {
        return chatClient.prompt("Set an alarm for "+ time +" minutes from now?").tools(dateTimeTools).call().content();
    }
